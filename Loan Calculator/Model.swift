...
class ReturnModel{
    ...
    func firstReturn(yearPercent:Double, monthlyPayment:Double, monthsAmount:Int) -> (Double, Double, Double, Bool){
        ...
        success = true
        return (amount, paymentPercent, paymentMoney, success)
    }
    ...
    func thirdReturn(mortgageAmount:Double, monthlyPayment:Double, yearPercent:Double) -> (Int, Int, Int, Double, Double, Bool){
        ...
        success = true
        return (monthsAmount, months, years, paymentPercent, paymentMoney, success)
    }
    
    
    func fourthReturn(mortgageAmount:Double, monthsAmount:Int, yearPercent:Double) -> (Double, Double, Double, Bool){
        monthPercent = calculations.monthPercentCalculation(yearPercent)
        ...
        paymentMoney = calculations.paymentMoneyCalculation(monthlyPayment: (monthlyPayment), monthsAmount: monthsAmount)
        success = true
        return (monthlyPayment, paymentPercent, paymentMoney, success)
    }
